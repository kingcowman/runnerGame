...
export default class filler_stairs extends Phaser.GameObjects.Container {

	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		super(scene, x ?? 488, y ?? 176);
		...
		// rectangle_33
		const rectangle_33 = scene.add.rectangle(-1228, 124, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_33.fillColor = 15525852;
		rectangle_33.strokeColor = 15664389;
		staircase2.add(rectangle_33);

		// rectangle_34
		const rectangle_34 = scene.add.rectangle(-1224, 120, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_34.fillColor = 15525852;
		rectangle_34.strokeColor = 15664389;
		staircase2.add(rectangle_34);

		// rectangle_35
		const rectangle_35 = scene.add.rectangle(-1220, 116, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_35.fillColor = 15525852;
		rectangle_35.strokeColor = 15664389;
		staircase2.add(rectangle_35);

		// rectangle_36
		const rectangle_36 = scene.add.rectangle(-1216, 112, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_36.fillColor = 15525852;
		rectangle_36.strokeColor = 15664389;
		staircase2.add(rectangle_36);

		// rectangle_37
		const rectangle_37 = scene.add.rectangle(-1212, 108, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_37.fillColor = 15525852;
		rectangle_37.strokeColor = 15664389;
		staircase2.add(rectangle_37);

		// rectangle_38
		const rectangle_38 = scene.add.rectangle(-1208, 104, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_38.fillColor = 15525852;
		rectangle_38.strokeColor = 15664389;
		staircase2.add(rectangle_38);

		// rectangle_39
		const rectangle_39 = scene.add.rectangle(-1204, 100, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_39.fillColor = 15525852;
		rectangle_39.strokeColor = 15664389;
		staircase2.add(rectangle_39);

		// rectangle_40
		const rectangle_40 = scene.add.rectangle(-1200, 96, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_40.fillColor = 15525852;
		rectangle_40.strokeColor = 15664389;
		staircase2.add(rectangle_40);

		// rectangle_41
		const rectangle_41 = scene.add.rectangle(-1196, 92, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_41.fillColor = 15525852;
		rectangle_41.strokeColor = 15664389;
		staircase2.add(rectangle_41);

		// rectangle_42
		const rectangle_42 = scene.add.rectangle(-1192, 88, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_42.fillColor = 15525852;
		rectangle_42.strokeColor = 15664389;
		staircase2.add(rectangle_42);

		// rectangle_43
		const rectangle_43 = scene.add.rectangle(-1188, 84, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_43.fillColor = 15525852;
		rectangle_43.strokeColor = 15664389;
		staircase2.add(rectangle_43);

		// rectangle_44
		const rectangle_44 = scene.add.rectangle(-1184, 80, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_44.fillColor = 15525852;
		rectangle_44.strokeColor = 15664389;
		staircase2.add(rectangle_44);

		// rectangle_45
		const rectangle_45 = scene.add.rectangle(-1180, 76, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_45.fillColor = 15525852;
		rectangle_45.strokeColor = 15664389;
		staircase2.add(rectangle_45);

		// rectangle_46
		const rectangle_46 = scene.add.rectangle(-1176, 72, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_46.fillColor = 15525852;
		rectangle_46.strokeColor = 15664389;
		staircase2.add(rectangle_46);

		// rectangle_47
		const rectangle_47 = scene.add.rectangle(-1172, 68, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_47.fillColor = 15525852;
		rectangle_47.strokeColor = 15664389;
		staircase2.add(rectangle_47);

		// rectangle_25
		const rectangle_25 = scene.add.rectangle(-1260, 156, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_25.fillColor = 15525852;
		rectangle_25.strokeColor = 15664389;
		staircase2.add(rectangle_25);

		// rectangle_26
		const rectangle_26 = scene.add.rectangle(-1256, 152, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_26.fillColor = 15525852;
		rectangle_26.strokeColor = 15664389;
		staircase2.add(rectangle_26);

		// rectangle_27
		const rectangle_27 = scene.add.rectangle(-1252, 148, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_27.fillColor = 15525852;
		rectangle_27.strokeColor = 15664389;
		staircase2.add(rectangle_27);

		// rectangle_28
		const rectangle_28 = scene.add.rectangle(-1248, 144, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_28.fillColor = 15525852;
		rectangle_28.strokeColor = 15664389;
		staircase2.add(rectangle_28);

		// rectangle_29
		const rectangle_29 = scene.add.rectangle(-1244, 140, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_29.fillColor = 15525852;
		rectangle_29.strokeColor = 15664389;
		staircase2.add(rectangle_29);

		// rectangle_30
		const rectangle_30 = scene.add.rectangle(-1240, 136, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_30.fillColor = 15525852;
		rectangle_30.strokeColor = 15664389;
		staircase2.add(rectangle_30);

		// rectangle_31
		const rectangle_31 = scene.add.rectangle(-1236, 132, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_31.fillColor = 15525852;
		rectangle_31.strokeColor = 15664389;
		staircase2.add(rectangle_31);

		// rectangle_32
		const rectangle_32 = scene.add.rectangle(-1232, 128, 100, 8) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		rectangle_32.fillColor = 15525852;
		...
		// nineslice
		const nineslice = scene.add.nineslice(648, -30, "stone1", undefined, 1200, 110, 4, 4, 4, 4) as Phaser.GameObjects.NineSlice & { body: Phaser.Physics.Arcade.Body };
		scene.physics.add.existing(nineslice, false);
		nineslice.body.pushable = false;
		nineslice.body.immovable = true;
		nineslice.body.setSize(1200, 110, false);
		this.add(nineslice);
		...
		rectangle.fillColor = 15525852;
		rectangle.strokeColor = 13224393;
		...
		rectangle_2.fillColor = 15525852;
		rectangle_2.strokeColor = 13224393;
		...
		rectangle_3.fillColor = 15525852;
		rectangle_3.strokeColor = 13224393;
		...
		rectangle_4.fillColor = 15525852;
		rectangle_4.strokeColor = 13224393;
		...
		rectangle_5.fillColor = 15525852;
		rectangle_5.strokeColor = 13224393;
		...
		rectangle_6.fillColor = 15525852;
		rectangle_6.strokeColor = 13224393;
		...
		rectangle_7.fillColor = 15525852;
		rectangle_7.strokeColor = 13224393;
		...
		rectangle_8.fillColor = 15525852;
		rectangle_8.strokeColor = 13224393;
		...
		rectangle_9.fillColor = 15525852;
		rectangle_9.strokeColor = 13224393;
		...
		rectangle_10.fillColor = 15525852;
		rectangle_10.strokeColor = 13224393;
		...
		rectangle_11.fillColor = 15525852;
		rectangle_11.strokeColor = 13224393;
		...
		rectangle_12.fillColor = 15525852;
		rectangle_12.strokeColor = 13224393;
		...
		rectangle_13.fillColor = 15525852;
		rectangle_13.strokeColor = 13224393;
		...
		rectangle_14.fillColor = 15525852;
		rectangle_14.strokeColor = 13224393;
		...
		rectangle_15.fillColor = 15525852;
		rectangle_15.strokeColor = 13224393;
		...
		rectangle_16.fillColor = 15525852;
		rectangle_16.strokeColor = 13224393;
		...
		rectangle_17.fillColor = 15525852;
		rectangle_17.strokeColor = 13224393;
		...
		rectangle_18.fillColor = 15525852;
		rectangle_18.strokeColor = 13224393;
		...
		rectangle_19.fillColor = 15525852;
		rectangle_19.strokeColor = 13224393;
		...
		rectangle_20.fillColor = 15525852;
		rectangle_20.strokeColor = 13224393;
		...
		rectangle_21.fillColor = 15525852;
		rectangle_21.strokeColor = 13224393;
		...
		rectangle_22.fillColor = 15525852;
		rectangle_22.strokeColor = 13224393;
		...
		rectangle_23.fillColor = 15525852;
		rectangle_23.strokeColor = 13224393;
		...
		rectangle_24.fillColor = 15525852;
		rectangle_24.strokeColor = 13224393;
		staircase.add(rectangle_24);

		// lists
		const platforms = [floor, nineslice_1, nineslice];
		const stairs = [rectangle_32, rectangle_31, rectangle_30, rectangle_29, rectangle_28, rectangle_27, rectangle_26, rectangle_25, rectangle_47, rectangle_46, rectangle_45, rectangle_44, rectangle_43, rectangle_42, rectangle_41, rectangle_40, rectangle_39, rectangle_38, rectangle_37, rectangle_36, rectangle_35, rectangle_34, rectangle_33, rectangle_24, rectangle_23, rectangle_22, rectangle_21, rectangle_20, rectangle_19, rectangle_18, rectangle_17, rectangle_16, rectangle_15, rectangle_14, rectangle_13, rectangle_12, rectangle_11, rectangle_10, rectangle_9, rectangle_8, rectangle_7, rectangle_6, rectangle_5, rectangle_4, rectangle_3, rectangle_2, rectangle];

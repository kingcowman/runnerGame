...
export default class filler_jumps1 extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		// nineslice
		const nineslice = scene.add.nineslice(128, -30, "stone1", undefined, 100, 16, 4, 4, 4, 4) as Phaser.GameObjects.NineSlice & { body: Phaser.Physics.Arcade.Body };
		...
		// nineslice_2
		const nineslice_2 = scene.add.nineslice(428, -30, "stone1", undefined, 100, 16, 4, 4, 4, 4) as Phaser.GameObjects.NineSlice & { body: Phaser.Physics.Arcade.Body };
		...
		// nineslice_3
		const nineslice_3 = scene.add.nineslice(-172, -30, "stone1", undefined, 100, 16, 4, 4, 4, 4) as Phaser.GameObjects.NineSlice & { body: Phaser.Physics.Arcade.Body };
		...
		// nineslice_4
		const nineslice_4 = scene.add.nineslice(976, -32, "stone1", undefined, 100, 16, 4, 4, 4, 4) as Phaser.GameObjects.NineSlice & { body: Phaser.Physics.Arcade.Body };
		...
		// nineslice_5
		const nineslice_5 = scene.add.nineslice(1276, -32, "stone1", undefined, 100, 16, 4, 4, 4, 4) as Phaser.GameObjects.NineSlice & { body: Phaser.Physics.Arcade.Body };
		...
		// nineslice_6
		const nineslice_6 = scene.add.nineslice(676, -32, "stone1", undefined, 100, 16, 4, 4, 4, 4) as Phaser.GameObjects.NineSlice & { body: Phaser.Physics.Arcade.Body };
		...
		// lists
		const platforms = [floor, nineslice_1, nineslice_3, nineslice_4, nineslice_6, nineslice_2, nineslice, nineslice_5];

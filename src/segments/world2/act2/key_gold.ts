...
export default class key_gold extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		// collect
		const collect = new Collect(scene, 956, -10, "gold");
		this.add(collect);
		...
		// lists
		const platforms = [rectangle_1, cave_platform, cave_platform_10, cave_platform_8, cave_platform_7, cave_platform_6, cave_platform_5, cave_platform_4, cave_platform_3, cave_platform_2, cave_platform_9];

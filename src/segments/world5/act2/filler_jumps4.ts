...
export default class filler_jumps4 extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		carnival_stripe_1.body.setSize(320, 32, false);
		carnival_stripe_1.tileScaleX = 3;
		this.add(carnival_stripe_1);

		// carnival_stripe
		const carnival_stripe = scene.add.tileSprite(-68, -126, 128, 32, "carnival_stripe") as Phaser.GameObjects.TileSprite & { body: Phaser.Physics.Arcade.Body };
		...
		// carnival_stripe_2
		const carnival_stripe_2 = scene.add.tileSprite(92, -62, 128, 32, "carnival_stripe") as Phaser.GameObjects.TileSprite & { body: Phaser.Physics.Arcade.Body };
		...
		// lists
		const platforms = [rectangle_1, carnival_stripe, carnival_stripe_2];

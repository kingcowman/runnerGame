...
export default class filler_jumps1 extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		// carnival_stripe_2
		const carnival_stripe_2 = scene.add.tileSprite(28, -126, 128, 32, "carnival_stripe") as Phaser.GameObjects.TileSprite & { body: Phaser.Physics.Arcade.Body };
		...
		// carnival_stripe
		const carnival_stripe = scene.add.tileSprite(-68, -62, 250, 32, "carnival_stripe") as Phaser.GameObjects.TileSprite & { body: Phaser.Physics.Arcade.Body };
		...
		carnival_stripe.body.setSize(250, 32, false);

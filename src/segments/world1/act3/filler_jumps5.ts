...
export default class filler_jumps5 extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		// rectangle
		const rectangle = scene.add.rectangle(252, -46, 128, 128) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		// rectangle_2
		const rectangle_2 = scene.add.rectangle(-20, -110, 128, 128) as Phaser.GameObjects.Rectangle & { body: Phaser.Physics.Arcade.Body };
		...
		// collect
		const collect = new Collect(scene, 60, -158, "atlas", "egg1.png");
		collect.scaleX = 0.8;
		collect.scaleY = 0.8;

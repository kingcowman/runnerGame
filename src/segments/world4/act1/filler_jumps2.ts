...
export default class filler_jumps2 extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		// soda_pallette_1
		const soda_pallette_1 = scene.add.image(-4, -62, "soda_pallette") as Phaser.GameObjects.Image & { body: Phaser.Physics.Arcade.Body };
		...
		soda_pallette_1.body.setOffset(232, 477);
		soda_pallette_1.body.setSize(544, 192, false);
		this.add(soda_pallette_1);

		// lists
		const platforms = [rectangle_1, soda_pallette];
